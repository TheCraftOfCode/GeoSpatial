      ...
      return Scaffold(
        ...
        body: SafeArea(
          child: Column(
            ...
            children: [
              DataCard('Individual data', 'Individual data entry for everyone in home', 'assets/svg/female.svg', IndividualDataCollection(),
                  Color(0xFFF700FF), Color(0xff3D2C8D)),
              DataCard('Community Details', 'Data entry for communities', 'assets/svg/house.svg', IndividualDataCollection(),
                  Color(0xFF2E2FFF), Color(0xFF4FD586)),
              DataCard('View saved data', 'View all data saved in local storage', 'assets/svg/storage_image.svg', IndividualDataCollection(),
