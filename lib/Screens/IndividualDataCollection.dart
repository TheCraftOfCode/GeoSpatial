          ...
          children:<Widget> [
            ...
            SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  children: <Widget>[
                    DataCard('Add new person','Enter details of a new family member','assets/svg/female.svg',FamilyMemberAdd(),
                    Color(0xFFF700FF),Color(0xff3D2C8D)),
                    DataCard('Edit existing person','Edit details of an existing family member','assets/svg/female.svg',FamilyMemberEdit(),
