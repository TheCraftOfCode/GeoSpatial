...
class DisplayVillageData extends StatefulWidget {
  const DisplayVillageData({Key? key}) : super(key: key);

  @override
  State<DisplayVillageData> createState() => _DisplayVillageDataState();
}

class _DisplayVillageDataState extends State<DisplayVillageData> {
        ...
        builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
          if (snapshot.hasData) {
            if (snapshot.requireData.statusCode != 200) {
              return Scaffold(
                appBar: AppBarBackButton("View Community Data"),
                body: Center(
